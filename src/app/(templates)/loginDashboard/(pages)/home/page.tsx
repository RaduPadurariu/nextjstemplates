...
import { LoginDashboardLineChart } from "../../components/Charts/LoginDashboardLineChart";
    ...
    <div className="w-full px-6 py-6 mx-auto">
      ...
      <ul className="flex flex-wrap -mx-3">
        {loginDashboardCardsData.map((card) => {
          return (
            ...
            >
              <div className="relative flex flex-col min-w-0 break-words bg-white shadow-xl rounded-2xl bg-clip-border dark:bg-slate-850 dark:shadow-dark-xl">
                  ...
                  <div className="flex flex-row -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                      <div>
                        ...
                        <h5 className="mb-2 font-bold text-[var(--dashboardTextTitles)] text-xl dark:text-white">
                          {card.data}
                        </h5>
        ...
        <div className="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none mb-8 lg:mb-0">
          <div className="border-black/12.5 dark:bg-slate-850 dark:shadow-dark-xl shadow-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
            <div className="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid p-6 pt-4 pb-0">
              <h6 className="capitalize text-[var(--dashboardTextTitles)] font-semibold pb-2 dark:text-white">
                Sales overview
              </h6>
            ...
            {loginDashboardHomeCarousel.map((item, index) => (
              ...
              >
                ...
                <div className="block text-start ml-12 left-0 bottom-0 absolute right-[15%] pt-5 pb-5 text-white">
                  ...
                  <p className="dark:opacity-80 text-xs sm:text-base">
                    {item.desc}
                  </p>
                </div>
              </SwiperSlide>
      ...
      <div className="flex flex-wrap mt-6 -mx-3">
          ...
          <div className="relative flex flex-col min-w-0 break-words bg-white border-0 border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl dark:bg-gray-950 border-black-125 rounded-2xl bg-clip-border">
            <div className="p-4 pb-0 mb-0 rounded-t-4">
              <div className="flex justify-between">
                <h6 className="mb-2 text-[var(--dashboardTextTitles)] font-semibold dark:text-white">
                  Sales by Country
                </h6>
              </div>
            </div>
            ...
            <div className="overflow-x-auto">
              <div className="flex flex-col w-full mb-4 border-collapse  dark:border-white/40">
                <ul className="min-w-[600px]">
                  {loginDashboardSalesData.map((data) => {
                    return (
                      ...
                      >
                        <div className="p-2 align-middle bg-transparent w-[30%] whitespace-nowrap dark:border-white/40">
                        ...
                        <div className="p-2 align-middle bg-transparent whitespace-nowrap dark:border-white/40">
                        ...
                        <div className="p-2 mr-10 text-sm leading-normal align-middle bg-transparent whitespace-nowrap dark:border-white/40">
        ...
        <div className="w-full max-w-full px-3 mt-0 lg:w-5/12 lg:flex-none">
          <div className="border-black/12.5 shadow-xl  relative flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border dark:bg-slate-850 dark:shadow-dark-xl">
            <div className="p-4 pb-0 rounded-t-4">
              <h6 className="mb-0 font-semibold text-[var(--dashboardTextTitles)] dark:text-white">
                Categories
              </h6>
            </div>
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="flex flex-col">
                          <h6 className="mb-1 font-semibold text-[var(--dashboardTextTitles)] text-sm leading-normal dark:text-white">
                            {category.title}
                          </h6>
...
export default LoginDashboardHomePage;
