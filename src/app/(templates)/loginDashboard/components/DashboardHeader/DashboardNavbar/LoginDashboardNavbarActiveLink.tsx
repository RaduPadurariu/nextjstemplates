  ...
  return (
    ...
    >
      <Link
        ...
        } text-sm my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-[var(--dashboardTextPrimary)] transition-colors dark:text-white dark:opacity-80`}
        href={link.link}
      >
