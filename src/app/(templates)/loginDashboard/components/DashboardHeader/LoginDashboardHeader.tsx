"use client";
import { loginDashboardNotificationList } from "@/data/loginDashboard";
          ...
          <ul className="flex flex-row justify-end pl-2 mb-0 list-none md-max:w-full">
            ...
            <li className="relative flex items-center pr-2">
              ...
              {isNotificationOpen && (
                <ul
                  dropdown-menu
                  className="text-sm transform-dropdown lg:shadow-3xl min-w-44 absolute right-0 top-9 z-50  list-none rounded-lg border-0 border-solid border-transparent dark:shadow-dark-xl dark:bg-slate-850 bg-white bg-clip-padding px-2 py-4 text-left text-[var(--dashboardTextPrimary)] transition-all sm:-mr-6 lg:absolute lg:right-0 lg:left-auto lg:mt-2 lg:block lg:cursor-pointer"
                >
                  {loginDashboardNotificationList.map((notification) => {
                    return (
                      <li key={notification.id} className="relative mb-2">
                        <div className="dark:hover:bg-[var(--dashboardBGDarkMode)] ease py-1.5 clear-both block w-full whitespace-nowrap rounded-lg bg-transparent px-4 duration-300 hover:bg-[var(--dashboardBGHover)] lg:transition-colors">
                          <div className="flex py-1">
                            ...
                            <div className="flex flex-col justify-center">
                              ...
                              <p className="mb-0 text-xs leading-tight text-[var(--dashboardTextMuted)] dark:text-white/80">
