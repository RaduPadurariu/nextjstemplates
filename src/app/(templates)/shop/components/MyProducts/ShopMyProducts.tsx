...
const ShopMyProducts = () => {
  ...
  useEffect(() => {
    ...
    const sorted = sortFunction ? [...byQuery].sort(sortFunction) : byQuery;

    setFilteredProducts(sorted);
  }, [selectedCategory, shopCatalogOption, searchParams]);
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchParams, selectedCategory, shopCatalogOption, itemsPerPage]);
