...
export const portalTemplatesList = [
  {
    ...
    desc: "Manage user profiles with a simulated login and personalized dashboard.",
  ...
  },
  {
    ...
    desc: "Responsive shop with filtering, sorting and full CRUD operations for product management.",
    link: "/shop",
...

  {
    ...
    desc: "Explore countries by population, area, and region with data fetched from a public API.",
    link: "/travel",
